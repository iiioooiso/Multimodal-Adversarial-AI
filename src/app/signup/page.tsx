...
export default function SignupPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    startTransition(async () => {
      const res = await signup(formData) as { error?: string; success?: boolean }
        ...
        <section className="grid flex-1 items-center gap-14 py-10 md:grid-cols-[1fr_420px] md:py-14">
          ...
          <div className="max-w-xl">
            ...
            <p className="mt-6 max-w-lg text-[15px] leading-7 text-white/55">
              Join teams using adversarial verification to catch unrealistic
              plans, reduce false optimism, and make faster product decisions
              with confidence.
            </p>
